...
<head>
  <title>EP&O - Electronic Purchase & Order</title>
...
<body>
  ...
  <div id='container'>
    ...
    <header class='clearfix fullwidth'>
      ...
      <h1>es</h1>&nbsp<h1 id='typewriter'></h1>
    </div>

          <!-- Collect the nav links, forms, and other content for toggling -->
          <div class='collapse navbar-collapse' id='bs-example-navbar-collapse-1'>
            <div class='extra-on-menu' >
              <a class='button-two target-link' href='https://dev.clinet.epno.app/'>Regístrate</a>
            ...
            <ul class='nav navbar-nav navbar-right navigate-section'>
              ...
              <li class='drop'>
                <a class='active' href='#home-section'>Servicios <i class='la la-angle-down'></i></a>
                <ul class='dropdown'>
                  <li>
