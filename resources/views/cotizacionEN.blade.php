    ...
    <div style="margin:5px;">
        ...
        <div class="divTable">
            <div class="divTableBody">
                <div class="divTableRow">
                    <div class="divTableCell"><img src="images/epno.png" alt="EP&O" style="width: 120;"></div>
                    <div class="divTableCell">&nbsp;RS: EPNO S DE RL DE CV Plaza Solid, Blvrd Municipio Libre 3529 Ju&aacute;rez, Chihuahua, M&eacute;xico</div>
        ...
        <div class="divTable" style="margin-top: 25;">
            <div class="divTableBody">
                ...
                @else
                <div class="divTableRow">
                    <div class="divTableCell" colspan="6" >NO HAY COTIZACIONES SELECCIONADAS</div>
